...
$=require("jquery"),$(document).ready(function(){var e=JSON.parse('{"requests":[{"id":0,"category":"Evacuation","tags":["Colin", "Is", "Awesome"],"title":"Example Request","description":"This is an example request. Here is a mini description that we have. We can list arguments and stuff here. I am just adding more to see how it would look if the text wrapped around to a second line.","location":"SCU","size":"2","contact":"crioux@scu.edu","time":"3/3/2018, 10:19:41 PM","claim":null,"status":null}]}\n');for(var t in $(".jobTitle").append('<h1 class="title is-1">'+e.requests[0].title+"</h1>"),$("#jobSize").append("<p>Job Size: "+e.requests[0].size+"</p>"),$(".jobDescription").append("<p>"+e.requests[0].description+"</p>"),$("#jobCategory").append('<h3 class="subtitle is-5">Request Type: '+e.requests[0].category+"</h3>"),$("#jobLocation").append('<p class="notification is-success"><b><strong>Job Location: </strong></b><br>'+e.requests[0].location+"</p>"),$(".contactInformation").append("<h4>Requesting Organization Contact Information: <br>"+e.requests[0].contact+"</h4>"),e.requests[0].tags)$(".tags").append('<small class="tag is-info">'+e.requests[0].tags[t]+" </small>");$(".date").append("<small>Posted on "+e.requests[0].time+"</small>")});
