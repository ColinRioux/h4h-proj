...
$=require("jquery"),$(document).ready(function(){var e=JSON.parse('{"requests":[{"id":0,"category":"food","tags":["food"," water"],"title":"Test","description":"Test","location":"HELP","size":"1","contact":"","time":"3/4/2018, 12:49:09 AM","claim":null,"status":null},{"id":1,"category":"food","tags":["food"," evac"],"title":"Swag","description":"lol this is lit","location":"Here","size":"5","contact":"lmao","time":"3/4/2018, 1:02:50 AM","claim":null,"status":null},{"id":2,"category":"Select Categories...","tags":["HORATIO"," NEEDS"," HELP"],"title":"Horatio Needs help","description":"He really needs fucking help","location":"","size":"Select Size...","contact":"","time":"3/4/2018, 1:43:46 AM","claim":null,"status":null}]}');for(var t in $(".jobTitle").append('<h1 class="title is-1">'+e.requests[0].title+"</h1>"),$("#jobSize").append("<p>Job Size: "+e.requests[0].size+"</p>"),$(".jobDescription").append("<p>"+e.requests[0].description+"</p>"),$("#jobCategory").append('<h3 class="subtitle is-5">Request Type: '+e.requests[0].category+"</h3>"),$("#jobLocation").append('<p class="notification is-success"><b><strong>Job Location: </strong></b><br>'+e.requests[0].location+"</p>"),$(".contactInformation").append("<h4>Requesting Organization Contact Information: <br>"+e.requests[0].contact+"</h4>"),e.requests[0].tags)$(".tags").append('<small class="tag is-info">'+e.requests[0].tags[t]+" </small>");$(".date").append("<small>Posted on "+e.requests[0].time+"</small>")});
