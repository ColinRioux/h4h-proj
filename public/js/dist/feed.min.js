...
$=require("jquery");var btn=document.getElementById("btnfilter"),file='{\r\n    "requests": [\r\n        {\r\n            "id": 0,\r\n            "category": [],\r\n            "tags": ["Food", "Evac"],\r\n            "title": "Example title",\r\n            "description": "Long ass description",\r\n            "requirements": [],\r\n            "location": "",\r\n            "size": 3,\r\n            "contact": "",\r\n            "claimed": "",\r\n            "status": "unclaimed"\r\n        },\r\n        {\r\n            "id": 1,\r\n            "category": [],\r\n            "tags": ["Clothes", "Food"],\r\n            "title": "Example title 2",\r\n            "description": "Long ass description",\r\n            "requirements": [],\r\n            "location": "",\r\n            "size": 3,\r\n            "contact": "",\r\n            "claimed": "",\r\n            "status": "unclaimed"\r\n        }\r\n    ]    \r\n}',data=JSON.parse(file);btn.onclick=function(){filter()};var search="Food";function filter(){for(var e in $(".searchfield").html(""),search=document.getElementById("filter").value,data.requests)if(""==search)$(".searchfield").append("<p>"+data.requests[e].title+"</p>");else{var r=data.requests[e].tags;for(var t in r)r[t]==search&&$(".searchfield").append("<p>"+data.requests[e].title+"</p>")}}$(document).ready(function(){filter()});
