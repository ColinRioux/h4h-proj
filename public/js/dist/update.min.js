...
var modal=document.getElementById("updateModal"),btn=document.getElementById("updateBtn"),span=document.getElementsByClassName("close")[0];btn.onclick=function(){modal.style.display="block"},span.onclick=function(){modal.style.display="none"},window.onclick=function(e){e.target==modal&&(modal.style.display="none")},$=require("jquery"),$(document).ready(function(){var e=JSON.parse('{\n    "requests": [\n        {\n            "id": 0,\n            "category": [],\n            "tags": ["Food", "Evac"],\n            "title": "Example title",\n            "description": "Long ass description",\n            "requirements": [],\n            "location": "",\n            "size": 3,\n            "contact": "",\n            "claimed": "Red Cross",\n            "status": "Delivered"\n        },\n        {\n            "id": 1,\n            "category": [],\n            "tags": ["Clothes", "Food"],\n            "title": "Example title 2",\n            "description": "Long ass description",\n            "requirements": [],\n            "location": "",\n            "size": 3,\n            "contact": "",\n            "claimed": "Red Cross",\n            "status": "En Route"\n        }\n    ]\n}\n');document.getElementById("jobTitle").innerHTML=e.requests[0].title,document.getElementById("organization").innerHTML=e.requests[0].claimed,document.getElementById("deliveryStatus").innerHTML=e.requests[0].status});
