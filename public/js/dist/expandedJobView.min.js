...
$=require("jquery"),$(document).ready(function(){var e=JSON.parse('{"requests":[{"id":0,"category":"evacuation","tags":["colin", "is", "awesome"],"title":"Example Request","description":"This is an example request. Here is a mini description that we have. We can list arguments and stuff here.","location":"SCU","size":"2","contact":"crioux@scu.edu","time":"3/3/2018, 10:19:41 PM","claim":null,"status":null}]}\n');for(var t in $(".jobTitle").append("<h1>"+e.requests[0].title+"</h1>"),$("#jobSize").append("<p>Job Size: "+e.requests[0].size+"</p>"),$(".jobDescription").append("<p>"+e.requests[0].description+"</p>"),$("#jobCategory").append("<h3>Request Type: "+e.requests[0].category+"</h3>"),$("#jobLocation").append("<p><b><strong>Job Location: </strong></b><br>"+e.requests[0].location+"</p>"),$(".contactInformation").append("<h4>Requesting Organization Contact Information: <br>"+e.requests[0].contact+"</h4>"),requests[0].tags)$(".tags").append("<small>"+e.requests[0].tags[t]+"</small>");$(".date").append("<small>Posted on "+e.requests[0].time+"</small>")});
