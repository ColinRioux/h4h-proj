...
function toggle_visibility(t){var a=document.getElementById(t);"block"==a.style.display?a.style.display="none":a.style.display="block"}$=require("jquery"),$(document).ready(function(){var t;if($.ajax({url:window.location.origin+"/requests/1",dataType:"json",async:!1,success:function(a){t=a}}),null!==t){for(var a in $(".jobTitle").append('<h1 class="title is-1">'+t.title+"</h1>"),"null"!==t.claim?$(".jobTitle").append('<h6 class="subtitle is-6">Claimed by: '+t.claim+"</h6>"):$(".jobTitle").append('<h6 class="subtitle is-6">Unclaimed</h6>'),$("#jobSize").append("<p>Job Size: "+t.size+"</p>"),$(".jobDescription").append("<p>"+t.description+"</p>"),$("#jobCategory").append('<h3 class="subtitle is-5">Request Type: '+t.category+"</h3>"),$("#jobLocation").append('<p class="notification is-success"><b><strong>Job Location: </strong></b><br>'+t.location+"</p>"),$(".contactInformation").append("<h4>Requesting Organization Contact Information: <br>"+t.contact+"</h4>"),t.tags)$(".tags").append('<small class="tag is-info">'+t.tags[a]+" </small>");$(".date").append("<small>Posted on "+t.time+"</small>")}});
