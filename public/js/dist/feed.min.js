...
function buildFeed(t){var i=JSON.parse('{"requests":[{"id":0,"category":"food","tags":["test"],"title":"Test","description":"Test","location":"Test","size":"2","contact":"test","time":"3/4/2018, 3:07:55 AM","claim":null,"status":null},{"id":1,"category":"water","tags":["test"],"title":"Hi Horatio","description":"Test","location":"Test","size":"2","contact":"test","time":"3/4/2018, 3:08:29 AM","claim":null,"status":null},{"id":2,"category":"food","tags":["test"],"title":"Testy test","description":"test","location":"t","size":"1","contact":"t","time":"3/4/2018, 3:09:09 AM","claim":null,"status":null},{"id":3,"category":"evacuation","tags":["G"],"title":"GOOOD","description":"G","location":"G","size":"4","contact":"G","time":"3/4/2018, 3:11:52 AM","claim":null,"status":null}]}');for(var e in $(t).html(""),i.requests){var s=i.requests[e];if($(t).append('<div class="box '+s.id+'" style="width:50%;"><h1 class="title is-4">'+s.title+'</h1><ul class="bxlc"><li><i class="fas fa-users"></i> Size:'+s.size+'</li><li><i class="fas fa-map-marker"></i> Location: '+s.location+'</li></ul><br/><p style="padding-top:2%">'+s.description+'</p><br/><ul class="tgclist"></ul><br/><a href="/job" class="button is-info">Inspect</a></div>'),"string"==typeof s.category){var a=[];a.push(s.category),s.category=a}for(var l in s.category)$(t).find("."+s.id).find(".tgclist").append('<li><div class="jobCategory">'+s.category[l]+"</div></li>");for(var n in $(t).find("."+s.id).find(".tgclist").append('<li style="padding-left:30px;"><i class="fas fa-tags"></i></li>'),s.tags)$(t).find("."+s.id).find(".tgclist").append('<li><div class="jobTag">'+s.tags[n]+"</div></li>")}}function filter(){$(".searchfield").html("");var t=$("#filter").val();for(var i in $("#feed").html(""),$("#feed").append("<p>"+t+"</p>"),tmp.requests){var e=tmp.requests[i];if("Search..."==t)$("#feed").append("<p>"+e.title+"</p>");else{var s=e.tags;for(var a in s)s[a]==t&&$("#feed").append("<p>"+e.title+"</p>")}}}function expandCard(t){window.location.replace("/job")}$=require("jquery"),$(document).ready(function(){buildFeed("#feed","t"),$("#btnfilter").click(function(){filter()}),$("#refreshJobs").click(function(){buildFeed("#feed")})});
