...
$=require("jquery");var btn=document.getElementById("btnfilter"),search="";function buildFeed(){$("#feed").html("");var e=JSON.parse('{"requests":[{"id":0,"category":"food","tags":["food"," water"],"title":"Test","description":"Test","location":"HELP","size":"1","contact":"","time":"3/4/2018, 12:49:09 AM","claim":null,"status":null},{"id":1,"category":"food","tags":["food"," evac"],"title":"Swag","description":"lol this is lit","location":"Here","size":"5","contact":"lmao","time":"3/4/2018, 1:02:50 AM","claim":null,"status":null}]}');for(var t in e.requests){var i=e.requests[t];if($("#feed").append('<div class="box '+i.id+'" style="width:50%;"><h1 class="title is-4">'+i.title+'</h1><ul class="bxlc"><li><i class="fas fa-users"></i> Size:'+i.size+'</li><li><i class="fas fa-map-marker"></i> Location: '+i.location+'</li></ul><br/><p style="padding-top:2%">'+i.description+'</p><br/><ul class="tgclist"></ul></div>'),"string"==typeof i.category){var a=[];a.push(i.category),i.category=a}for(var s in i.category)$("."+i.id).find(".tgclist").append('<li><div class="jobCategory">'+i.category[s]+"</div></li>");$("."+i.id).find(".tgclist").append('<li style="padding-left:30px;"><i class="fas fa-tags"></i></li>')}}function filter(){for(var e in search=document.getElementById("filter").value,$(".searchfield").append("<p>"+search+"</p>"),data.requests)if("Search..."==search)$(".searchfield").append("<p>"+data.requests[e].title+"</p>");else{var t=data.requests[e].tags;for(var i in t)t[i]==search&&$(".searchfield").append("<p>"+data.requests[e].title+"</p>")}}btn.onclick=function(){filter()},$(document).ready(function(){buildFeed(),$("#btnfilter").click(function(){filter()}),window.setInterval(function(){buildFeed()},1e4)});
