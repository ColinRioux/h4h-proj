...
function updateCategories(e){for(var a in e.categories)$("#categoriesSelector").append($("<option/>",{value:e.categories[a],text:e.categories[a]}))}function updateJobSizes(e){for(var a in e.sizes)$("#jobSizeSelector").append($("<option/>",{value:parseInt(a)+1,text:e.sizes[a]}))}$=require("jquery"),$(document).ready(function(){var e=JSON.parse('{\n    "categories": ["food", "water", "evacuation", "clothes", "power"],\n    "sizes": ["Extra-Small", "Small", "Medium", "Large", "Extra-Large"]\n}');updateCategories(e),updateJobSizes(e)});
