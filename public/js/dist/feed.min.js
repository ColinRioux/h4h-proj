...
$=require("jquery"),$(document).ready(function(){var i=JSON.parse('{"requests":[{"id":0,"category":"evacuation","tags":"colin, is, awesome","title":"Example Request","description":"This is an example request. Here is a mini description that we have. We can list arguments and stuff here.","location":"SCU","size":"2","contact":"crioux@scu.edu","time":"3/3/2018, 10:19:41 PM","claim":null,"status":null}]}');for(var s in i.requests){var e=i.requests[s];$("#feed").append('<div class="box" style="width:50%;"><h1 class="title is-4">'+e.title+'</h1><ul class="bxlc"><li><i class="fas fa-users"></i> Size:'+e.size+'</li><li><i class="fas fa-map-marker"></i> Location: '+e.location+'</li></ul><br/><p style="padding-top:2%">'+e.description+'</p><br/><ul class="tgclist"><li><div class="jobCategory">Supplies</div></li><li style="padding-left:30px;"><i class="fas fa-tags"></i></li></ul></div>')}});
