...
$=require("jquery");var counter,search="";function expandCard(){alert("Hi")}function buildRequesterFeed(e){var n=JSON.parse('{\n    "requests": [\n        {\n            "id": 0,\n            "category": [],\n            "tags": ["Food", "Evac"],\n            "title": "Example title",\n            "description": "Fire, need evacuation",\n            "requirements": [],\n            "location": "San Jose, CA",\n            "size": 3,\n            "contact": "",\n            "claimed": "Red Cross",\n            "status": "Delivered"\n        },\n        {\n            "id": 1,\n            "category": [],\n            "tags": ["Clothes", "Food"],\n            "title": "Example title 2",\n            "description": "Flood, need food",\n            "requirements": [],\n            "location": "Los Angeles, CA",\n            "size": 3,\n            "contact": "",\n            "claimed": "null",\n            "status": "En Route"\n        },\n        {\n            "id": 2,\n            "category": [],\n            "tags": ["Clothes", "Water"],\n            "title": "Example title 3",\n            "description": "Earthquake, need water",\n            "requirements": [],\n            "location": "Seattle, WA",\n            "size": 3,\n            "contact": "",\n            "claimed": "Red Cross",\n            "status": "En Route"\n        }\n    ]\n}\n');for(var t in n.requests){var i=n.requests[t];$(e).append('<div class="box '+i.id+'" onclick="expandCard()" style="width:50%;"><h1 class="title is-4">'+i.title+'</h1><ul class="bxlc"><li><i class="fas fa-users"></i> Size:'+i.size+'</li><li><i class="fas fa-map-marker"></i> Location: '+i.location+'</li></ul><br/><p style="padding-top:2%">'+i.description+'</p><br/><ul class="tgclist"></ul></div>'),counter=t}}$(document).ready(function(){buildRequesterFeed("#feed"),$("#btnfilter").click(function(){search=$("#filter").val(),buildRequesterFeed("#feed")}),$("#refreshJobs").click(function(){buildRequesterFeed("#feed")})});
