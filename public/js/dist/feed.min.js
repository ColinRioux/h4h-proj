...
$=require("jquery");var tmp=JSON.parse('{"requests":[{"id":0,"category":"food","tags":["food"," water"],"title":"Test","description":"Test","location":"HELP","size":"1","contact":"","time":"3/4/2018, 12:49:09 AM","claim":null,"status":null},{"id":1,"category":"food","tags":["food"," evac"],"title":"Swag","description":"lol this is lit","location":"Here","size":"5","contact":"lmao","time":"3/4/2018, 1:02:50 AM","claim":null,"status":null}]}'),search="";function buildFeed(){for(var i in $("#feed").html(""),tmp.requests){var e=tmp.requests[i];if($("#feed").append('<div class="box '+e.id+'" style="width:50%;"><h1 class="title is-4">'+e.title+'</h1><ul class="bxlc"><li><i class="fas fa-users"></i> Size:'+e.size+'</li><li><i class="fas fa-map-marker"></i> Location: '+e.location+'</li></ul><br/><p style="padding-top:2%">'+e.description+'</p><br/><ul class="tgclist"></ul></div>'),"string"==typeof e.category){var t=[];t.push(e.category),e.category=t}for(var a in e.category)$("."+e.id).find(".tgclist").append('<li><div class="jobCategory">'+e.category[a]+"</div></li>");for(var s in $("."+e.id).find(".tgclist").append('<li style="padding-left:30px;"><i class="fas fa-tags"></i></li>'),e.tags)$("."+e.id).find(".tgclist").append('<li><div class="jobTag">'+e.tags[s]+"</div></li>")}}function filter(){for(var i in $(".searchfield").html(""),search=$("#filter").val(),$(".searchfield").append("<p>"+search+"</p>"),tmp.requests){var e=tmp.requests[i];if("Search..."==search)$(".searchfield").append("<p>"+e.title+"</p>");else{var t=e.tags;for(var a in t)t[a]==search&&$(".searchfield").append("<p>"+e.title+"</p>")}}}$(document).ready(function(){buildFeed(),$("#btnfilter").click(function(){filter()}),window.setInterval(function(){buildFeed()},1e4)});
