...
$=require("jquery");var search="";function buildFeed(e,i){var t=JSON.parse('{"requests":[{"id":0,"category":"food","tags":["food"," water"],"title":"Test","description":"Test","location":"HELP","size":"1","contact":"","time":"3/4/2018, 12:49:09 AM","claim":null,"status":null},{"id":1,"category":"food","tags":["food"," evac"],"title":"Swag","description":"lol this is lit","location":"Here","size":"5","contact":"lmao","time":"3/4/2018, 1:02:50 AM","claim":null,"status":null},{"id":2,"category":"Select Categories...","tags":["HORATIO"," NEEDS"," HELP"],"title":"Horatio Needs help","description":"He really needs fucking help","location":"","size":"Select Size...","contact":"","time":"3/4/2018, 1:43:46 AM","claim":null,"status":null}]}');for(var a in $(e).html(""),t.requests){var l=t.requests[a],s=!0;if(i)for(var r in s=!1,l.tags)tags[r]==search&&(s=!0);if(s){if($(e).append('<div class="box '+l.id+'" style="width:50%;" onclick="expandCard'+l.id+'"><h1 class="title is-4">'+l.title+'</h1><ul class="bxlc"><li><i class="fas fa-users"></i> Size:'+l.size+'</li><li><i class="fas fa-map-marker"></i> Location: '+l.location+'</li></ul><br/><p style="padding-top:2%">'+l.description+'</p><br/><ul class="tgclist"></ul></div>'),"string"==typeof l.category){var c=[];c.push(l.category),l.category=c}for(var d in l.category)$(e).find("."+l.id).find(".tgclist").append('<li><div class="jobCategory">'+l.category[d]+"</div></li>");for(var o in $(e).find("."+l.id).find(".tgclist").append('<li style="padding-left:30px;"><i class="fas fa-tags"></i></li>'),l.tags)$(e).find("."+l.id).find(".tgclist").append('<li><div class="jobTag">'+l.tags[o]+"</div></li>")}}}function filter(){for(var e in $(".searchfield").html(""),search=$("#filter").val(),tmp.requests){var i=tmp.requests[e];if("Search..."==search)$(".searchfield").append("<p>"+i.title+"</p>");else{var t=i.tags;for(var a in t)t[a]==search&&$(".searchfield").append("<p>"+i.title+"</p>")}}}function expandCard(e){}$(document).ready(function(){buildFeed("#feed",!1),$("#btnfilter").click(function(){search=$("#filter").val(),buildFeed("#feed",!0)}),$("#refreshJobs").click(function(){buildFeed("#feed",!1)})});
